                                ...
                                <div class="flex gap-4 md:flex-col md:items-center">
                                    ...
                                    <div class="w-28 md:w-full flex justify-center">
                                        <img src="{{ asset('img/vehicles/' . $vehicle->image) }}"
                                            class="h-24 md:h-48 object-contain" alt="{{ $vehicle->name }}">
                                    </div>
                                    <!-- INFO -->
                                    <div class="flex flex-col justify-end md:justify-between flex-1 w-full">
                                        <!-- Plate -->
                                        <div
                                            class="flex items-center justify-end sm:justify-normal gap-2 text-md text-gray-500 mb-2">
                                        ...
                                        <div class="flex justify-end sm:justify-between items-center">
                                            <!-- Price Desktop-->
                                            <p
                                                class="hidden sm:flex text-base md:text-lg font-bold text-gray-800 items-center">
                                                Rp. {{ number_format($vehicle->price_per_day, 0, ',', '.') }}/<span
